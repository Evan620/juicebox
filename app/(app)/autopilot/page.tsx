    ...
    <div className="min-h-screen bg-[#FAFAFA]">
      ...
      <div className="bg-white border-b border-[#E5E5E5] px-8 py-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold text-[#1A1A1A]">Autopilot</h1>
            <p className="text-sm text-[#666666] mt-1">AI-powered batch candidate evaluation</p>
          </div>
        ...
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="Search autopilots by name or criteria..."
      ...
      <div className="px-8 py-8">
        <div className="text-center py-16">
          <div className="w-16 h-16 mx-auto mb-4 bg-[#F5F5F5] rounded-full flex items-center justify-center">
            <Zap size={32} className="text-[#999999]" />
          </div>
          <h2 className="text-xl font-semibold text-[#1A1A1A] mb-2">Autopilot feature coming soon</h2>
          <p className="text-sm text-[#666666] mb-6">
            Let AI evaluate hundreds of candidates automatically based on your criteria
          </p>
